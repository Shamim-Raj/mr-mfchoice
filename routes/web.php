...
use App\Http\Controllers\Frontend\SublandingPageController;
use App\Http\Controllers\Frontend\SellerController;
use App\Http\Controllers\Frontend\SubBuyNowController;
...
Route::post('buynow-without-auth', [SublandingPageController::class, 'store_without_auth']);
// Route::post('sub-buynow', [SubBuyNowController::class, 'store']);
