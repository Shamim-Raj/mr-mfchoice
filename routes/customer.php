...
// Buy Now
Route::resource('buynow', Frontend\BuyNowController::class)->only('index', 'store', 'substore');
...
Route::get('success-order',[PaymentController::class,'sub_orderSuccess'])->name('customer.sub-order-success');
