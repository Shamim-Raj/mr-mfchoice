                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="input-group">
                                            <input type="text" name="first_name" value="<?php echo e(($billing->first_name) ?? (auth('customer')->user()->first_name) ?? ''); ?>" placeholder="">
                                            <span class="label"><?php echo e(__('আপনার নাম')); ?> <span class="text-danger">*</span></span>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="input-group">
                                            <input type="number" name="mobile" value="<?php echo e(($billing->mobile) ?? (auth('customer')->user()->mobile) ?? ''); ?>">
                                            <span class="label"><?php echo e(__('মোবাইল নাম্বার')); ?> <span class="text-danger">*</span></span>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="input-group">
                                            <input type="text" name="shipping_address" value="">
                                            <span class="label"><?php echo e(__('সম্পূর্ণ ঠিকানা দিন')); ?> <span class="text-danger">*</span></span>
                                        </div>
                                    </div>
                                        ...
                                        <div class="contact-infos my-3">
                                            ...
                                            <div class="details-meta-items justify-content-between d-flex flex-wrap my-2">
                                                <div class="form-check ps-0">
                                                    <input class="form-check-input" type="radio" value="<?php echo e((($product->details)->is_free_shipping==1 ? 0 : $product->shipping_cost) ?? 0); ?>" onclick="shippingCharge(this.value)" name="delivery_charge" id="insideCharge" checked >
                                                ...
                                                <b>
                                                    <?php if(($product->details)->is_free_shipping==1): ?>
                                                    <?php echo e('Free'); ?>

                                                    <?php else: ?>
                                                    <?php echo e($product->shipping_cost ?? 00); ?>
                                            ...
                                            <div class="details-meta-items justify-content-between d-flex flex-wrap my-2">
                                                <div class="form-check ps-0">
                                                    <input class="form-check-input" type="radio" value=" <?php echo e((($product->details)->is_free_shipping==1 ? 0 :  $product->outside_shipping_cost) ?? 0); ?>" onclick="shippingCharge(this.value)" name="delivery_charge" id="outsideCharge" >
                                                ...
                                                <b>
                                                    ...
                                                    <?php else: ?>
                                                    <?php echo e($product->outside_shipping_cost ?? 00); ?>
                                    ...
                                    <ul id="order-details">
                                        ...
                                        <li><?php echo e(__('Shipping Charge')); ?>
                                            ...
                                            <span style="position: relative; left:-70px;">৳ </span><span id="shipping_cost">
                                                ...
                                                <?php else: ?>
                                                <?php echo e($product->shipping_cost ?? 0); ?>

                                                <?php endif; ?>         
                                            </span>
                                            <input type="hidden" id="shipping_cost_input" name="shipping_cost_input" value="<?php echo e($product->shipping_cost ?? 0); ?>"></li>
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\office\mf-final2\main_last\resources\views/customer/buynow/sub-checkout.blade.php ENDPATH**/ ?>