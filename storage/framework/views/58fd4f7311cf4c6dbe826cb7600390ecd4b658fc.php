...
<head>
    ...
    <!-- lity js -->
    <link rel="stylesheet" href="<?php echo e(asset('frontend/lity/venobox.css')); ?>">
    <!-- Font Awesome -->
...
<script src="<?php echo e(asset('frontend/lity/venobox.js')); ?>"></script>
<!-- product zoom js -->
...
<script>
    ...
    $( "#all-item-tab" ).click(function() {
        $( ".countdown" ).show();
    });
    $( "#new-arrivals-tab" ).click(function() {
        $( ".countdown" ).hide();
    });
...
<?php /**PATH /home/mfchoice/public_html/mr.mfchoice.com/resources/views/frontend/layouts/front.blade.php ENDPATH**/ ?>