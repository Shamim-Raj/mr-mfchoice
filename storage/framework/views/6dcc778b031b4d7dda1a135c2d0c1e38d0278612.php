...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="button-group">
                    ...
                    <a href="<?php echo e(url('/seller/login')); ?>" class="btn login-btn d-none"><?php echo e(__('Seller')); ?></a>
                    <a href="<?php echo e(url('/login')); ?>" class="btn login-btn d-none"><?php echo e(__('Customer')); ?></a>
                </div>
...
<?php /**PATH /home/mfchoice/public_html/mr.mfchoice.com/resources/views/backend/pages/auth/login.blade.php ENDPATH**/ ?>