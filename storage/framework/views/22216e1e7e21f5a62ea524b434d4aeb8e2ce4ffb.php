<div class="row">
    ...
    <div class="col-lg-7">
        <div class="input-group">
            <input name="first_name" type="text" required class="form-control <?php echo e($errors->has('first_name') ? ' is-invalid' : ''); ?>" value="<?php if($customer->first_name): ?><?php echo e($customer->first_name); ?><?php else: ?><?php echo e(old('first_name')); ?><?php endif; ?>" placeholder="First Name">
    ...
    <div class="col-lg-3">
        <p><?php echo e(__('Last Name')); ?> <span class="text-red">*</span></p>
    </div>
    <div class="col-lg-7">
        <div class="input-group">
            <input name="last_name" type="text" class="form-control <?php echo e($errors->has('last_name') ? ' is-invalid' : ''); ?>" value="<?php if($customer->last_name): ?><?php echo e($customer->last_name); ?><?php else: ?><?php echo e(old('last_name')); ?><?php endif; ?>" placeholder="Last Name">
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="col-lg-3">
        <p><?php echo e(__('Username')); ?><span class="text-red">*</span></p>
    </div>
    <div class="col-lg-7">
        <div class="input-group">
            <input name="username" type="text"
                   class="form-control <?php echo e($errors->has('username') ? ' is-invalid' : ''); ?>"
                   value="<?php if($customer->username): ?><?php echo e($customer->username); ?><?php else: ?><?php echo e(old('username')); ?><?php endif; ?>"
...
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
            <label id="username-error" class="invalid-feedback error" for="username"><?php echo e($message); ?></label>
            <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/mfchoice/public_html/mr.mfchoice.com/app/Modules/Backend/CustomerManagement/Resources/views/customers/form.blade.php ENDPATH**/ ?>