...
<div class="nav nav-tabs p-tab-manu" id="nav-tab" role="tablist">
    ...
    <button class="nav-link <?php if(Request::is('admin/website_setting/announcements','admin/website_setting/announcements/*')): ?>active <?php endif; ?>" id="announcements-tab" data-bs-toggle="tab" data-bs-target="#announcements" type="button" role="tab" aria-controls="announcements" aria-selected="false" <?php if(url()->full()!=route('backend.announcements.index')): ?> onclick="location.href='<?php echo e(route('backend.announcements.index')); ?>'" <?php endif; ?>
    ><?php echo e(__('Announcements')); ?>

    </button>
</div>
<?php /**PATH /home/mfchoice/public_html/mr.mfchoice.com/resources/views/backend/pages/website_setting/nav.blade.php ENDPATH**/ ?>