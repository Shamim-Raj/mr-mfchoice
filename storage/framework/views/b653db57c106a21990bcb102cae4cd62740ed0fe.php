...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="col-md-7">
                                                    <img id="logo" src="<?php echo e(asset('uploads/'.$appearance->logo)); ?>"
                                                         alt="logo" width="150">
                                                    <div class="input-group">
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="col-md-7">
                                                    <img id="favicon" src="<?php echo e(asset('uploads/'.$appearance->favicon)); ?>"
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="col-md-7">
                                                    <img id="backend_logo" src="<?php echo e(asset('uploads/'.$appearance->backend_logo)); ?>"
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mfchoice/public_html/mr.mfchoice.com/resources/views/backend/pages/website_setting/appearance.blade.php ENDPATH**/ ?>