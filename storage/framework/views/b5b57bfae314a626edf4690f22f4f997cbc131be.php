        ...
        <div class="container">
                                            ...
                                            <?php if($productstock->color->name ?? false): ?>
                                                <li>
                                                    <label class="product-size">
                                                        <input name="color"  value="<?php echo e($productstock->color->name); ?>" type="radio" data-color_id="<?php echo e($productstock->color->id); ?>" class="color-variation">
                                    ...
                                    <ul>
                                        <?php $__currentLoopData = $product->productstock->unique('size_id') ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productstock): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($productstock->size->name ?? false): ?>
                                                <li>
                                                    <label class="product-size">
                                                        <input type="radio"  name="size" value="<?php echo e($productstock->size->name ?? ''); ?>" data-size_id="<?php echo e($productstock->size->id); ?>" class="size-variation">
            ...
            <div class="tab-info">
                <ul class="nav nav-tabs" id="myTab">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="description-tab" data-bs-toggle="tab" data-bs-target="#description" type="button" role="tab" aria-controls="description" aria-selected="false"><?php echo e(__('Description')); ?></button>
                    </li>
                    <li class="nav-item" role="presentation">
...
<?php echo $__env->make('frontend.layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mfchoice/public_html/mr.mfchoice.com/resources/views/frontend/pages/product-details-2.blade.php ENDPATH**/ ?>