                ...
                <div class="layout-items position-center">
                    <div class="multiventors-details-middle new-product-detais">
                        ...
                        <div class="cart-button-wrapper" onclick="myFunction()">
                            ...
                            <a href="#billing"class="btn order-now-btn m-2 p-2 <?php if (! ($product->quantity && $product->is_manage_stock)): ?> disabled <?php endif; ?>" style="background:#ff8400; color:#fff; font-weight:600"><?php echo e(__('অর্ডার করতে চাই')); ?></a>
...
<?php echo $__env->make('frontend.layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\office\mf-final2\main_last\resources\views/frontend/pages/sub-product-details-2.blade.php ENDPATH**/ ?>