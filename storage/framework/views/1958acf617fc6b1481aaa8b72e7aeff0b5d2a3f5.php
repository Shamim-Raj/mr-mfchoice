                ...
                <div class="container">
                    ...
                    <div class="content-table mt-0">
                        ...
                        <div class="col-xxl-3 col-lg-3 col-md-6 mb-2">
                            ...
                            <form action="<?php echo e(route('backend.products.wholesale')); ?>" method="GET">
                                <?php echo csrf_field(); ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="w-120">
                                                        <div class="form-switch">
                                                            <input class="form-check-input status" type="checkbox" value="<?php echo e($wholesale->status); ?>" <?php if($wholesale->status==1): ?> checked <?php endif; ?> " data-id="<?php echo e($wholesale->id); ?>">
                                                        </div>
                                                    </td>
        ...
        $(function() {
            ...
            /*$(document).ready(function(){
             ...
             /*$(document).ready(function(){
                ...
                table.DataTable({
                    ajax: "<?php if(auth()->guard('admin')->check()): ?><?php echo e(route('backend.products.wholesale-list')); ?><?php endif; ?>",
                    columns: [
                        { data: 'id' },
                        { data: 'name' },
                        { data: 'in_table' },
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mfchoice/public_html/mr.mfchoice.com/app/Modules/Backend/ProductManagement/Resources/views/wholesales/index.blade.php ENDPATH**/ ?>