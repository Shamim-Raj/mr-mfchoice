                            ...
                            <table id="colorTable" class="table p-table text-center">
                                ...
                                <?php $__currentLoopData = $colors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><div class="form-switch"><input class="form-check-input status" type="checkbox" data-id="<?php echo e($color->id); ?>" <?php if($color->is_active): ?> checked <?php endif; ?>></div></td>
                                        <td> 
                                            <ul>
                                                <li>
                                                    <a class="p-0 action" href="<?php echo e(route('backend.colors.edit' , $color->id )); ?>">
                                                ...
                                                <li>
                                                    <form user="deleteForm" method="POST"
                                                          action="<?php echo e(route('backend.colors.destroy',$color->id )); ?>">
                                                        <?php echo csrf_field(); ?>
        ...
        $(document).ready(function(){
            ...
            $(document).on('click', '#colorTable .status', function () {
                ...
                $.ajax({
                    type: "GET",
                    dataType: "json",
                    url: "<?php echo e(route('colors.status')); ?>",
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mfchoice/public_html/mr.mfchoice.com/resources/views/backend/pages/colors/pages/index.blade.php ENDPATH**/ ?>