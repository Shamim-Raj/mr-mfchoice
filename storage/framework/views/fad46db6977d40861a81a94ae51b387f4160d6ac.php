            ...
            <div class="row justify-content-center">
                <div class="col-lg-7 col-lg-6 text-center">
                    ...
                    <div class="mybazar-payment-delivery-date-link">
                        <p><?php echo e(__('For More Details, Track Your Delivery Status Under')); ?> <span><?php echo e(__('My Account')); ?> > <?php echo e(__('Order')); ?></span> <a href="<?php echo e(route('customer.order')); ?>"><?php echo e(__('View Order')); ?></a></p>
                    </div>
...
<?php echo $__env->make('frontend.layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\office\mf-final2\main_last\resources\views/customer/checkout/payment-success.blade.php ENDPATH**/ ?>