...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-lg-4">
                <select name="unit" required
                    class="form-select form-control<?php echo e($errors->has('unit') ? ' is-invalid' : ''); ?>">
            ...
            <div class="col-lg-4">
                <div class="input-group">
                    <div class="form-check form-switch btn-one-off">
                        ...
                        <input name="is_refundable" <?php if($product->is_refundable || old('is_refundable')): ?> checked <?php endif; ?>
            ...
            <div class="col-lg-4">
                <div class="input-group">
                    <input type="text" name="slug"
                        ...
                        value="<?php if($product->slug): ?> <?php echo e($product->slug); ?><?php else: ?><?php echo e(old('slug')); ?> <?php endif; ?>"
                        placeholder="Slug">
                ...
                <div class="col-lg-4">
                    <div class="input-group">
                        <select name="seller_id"
                            class="seller form-select form-control<?php echo e($errors->has('seller_id') ? ' is-invalid' : ''); ?>"
                            required>
                            <option value=""><?php echo e(__('Select Seller')); ?></option>
                            <?php $__currentLoopData = $sellers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $seller): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($seller->id); ?>"
                                    <?php if($seller->id == $product->seller_id): ?> selected <?php endif; ?>><?php echo e($seller->company_name ?? ''); ?>
            ...
            <div class="col-lg-4">
                <div class="input-group">
                    <input type="text" name="warranty" class="form-control"
                        value="<?php if($product->warranty): ?> <?php echo e($product->warranty); ?><?php else: ?><?php echo e(old('warranty')); ?> <?php endif; ?>"
                ...
                <div class="card-body">
                    <div class="accordion mb-4" id="accordionExample">
                        <div class="accordion-item">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse <?php echo e($product->productstock ? 'show':''); ?>" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    ...
                                    <div class="variants">
                                        ...
                                        <div class="input-group mb-4">
                                            ...
                                            <input type="number" class="form-control" placeholder="Enter quantity" name="quantities[]" value="<?php echo e($productstock->quantities); ?>">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <p><?php echo e(__('Shipping Cost(Inside Dhaka)')); ?></p>
                        </div>
                        <div class="col-lg-8">
                            <div class="input-group overflow-visible">
                                <input name="shipping_cost" min="0" type="number" class="form-control" placeholder="0" value="<?php echo e($product->shipping_cost); ?>">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <p><?php echo e(__('Shipping Cost(Outside Dhaka)')); ?></p>
                        </div>
                        <div class="col-lg-8">
                            <div class="input-group overflow-visible">
                                <input name="outside_shipping_cost" min="0" type="number" class="form-control" placeholder="0" value="<?php echo e($product->outside_shipping_cost); ?>">
                            </div>
                        </div>
                        <div class="col-lg-4">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <div class="input-group">
                                <textarea name="meta_description" class="form-control"> <?php if($product->meta_description): ?> <?php echo e($product->meta_description); ?><?php else: ?><?php echo e(old('meta_description')); ?><?php endif; ?></textarea>
                            </div>
                        </div>
                        <div class="col-lg-4">
                        ...
                        <div class="col-3">
                            <div class="form-switch">
                                ...
                                <input name="is_free_shipping" value="1" class="form-check-input"
                                    <?php if(($product->details && $product->details->is_free_shipping) || old('is_free_shipping') == 1): ?> checked <?php endif; ?> type="checkbox">
                            </div>
                        </div>
                        <div class="col-9">
                        ...
                        <div class="col-3">
                            <div class="form-switch">
                                ...
                                <input name="is_flat_rate" value="1" class="form-check-input"
                                    <?php if(($product->details && $product->details->is_flat_rate) || old('is_flat_rate') == 1): ?> checked <?php endif; ?> type="checkbox">
                            </div>
                        </div>
                        <div class="col-9">
                        ...
                        <div class="col-3">
                            <div class="form-switch">
                                ...
                                <input name="is_product_wise_shipping" value="1" class="form-check-input"
                                    <?php if($product->details && $product->details->is_product_wise_shipping): ?> checked <?php endif; ?> type="checkbox">
                            </div>
                        </div>
                        <div class="col-9">
                        ...
                        <div class="col-3">
                            <div class="form-switch">
                                ...
                                <input name="is_quantity_multiply" value="1" class="form-check-input"
                                    <?php if($product->details && $product->details->is_quantity_multiply): ?> checked <?php endif; ?> type="checkbox">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-3">
                            <div class="form-switch">
                                ...
                                <input name="is_show_stock_quantity" value="1" class="form-check-input"
                                    <?php if($product->details && $product->details->is_show_stock_quantity): ?> checked <?php endif; ?>
                                    <?php if(Request::is('admin/products/create')): ?> checked <?php endif; ?> type="checkbox">
                            </div>
                        </div>
                        <div class="col-9">
                        ...
                        <div class="col-3">
                            <div class="form-switch">
                                ...
                                <input name="is_show_stock_with_text_only" value="1" class="form-check-input"
                                    <?php if($product->details && $product->details->is_show_stock_with_text_only): ?> checked <?php endif; ?> type="checkbox">
                            </div>
                        </div>
                        <div class="col-9">
                        ...
                        <div class="col-3">
                            <div class="form-switch">
                                ...
                                <input name="is_hide_stock" value="1" class="form-check-input"
                                    <?php if($product->details && $product->details->is_hide_stock): ?> checked <?php endif; ?> type="checkbox">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-3">
                            <div class="form-switch">
                                ...
                                <input name="is_cash_on_delivery" value="1" class="form-check-input"
                                    <?php if($product->details && $product->details->is_cash_on_delivery): ?> checked <?php endif; ?> type="checkbox">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-3">
                            <div class="form-switch">
                                ...
                                <input name="is_best_sell" value="1" class="form-check-input"
                                    <?php if($product->details && $product->details->is_best_sell): ?> checked <?php endif; ?> type="checkbox">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="date" value="<?php echo e(optional($product->details)->flash_start_at); ?>" name="flash_start_at" class="form-control">
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                <label><?php echo e(__('End Date')); ?></label>
                                <input type="date" value="<?php echo e(optional($product->details)->flash_end_at); ?>" name="flash_end_at" class="form-control"/>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/mfchoice/public_html/mr.mfchoice.com/app/Modules/Backend/ProductManagement/Resources/views/products/form.blade.php ENDPATH**/ ?>