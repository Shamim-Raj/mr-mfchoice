                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="row">
                                                ...
                                                <div class="col-md-7">
                                                    <img id="logo" src="{{asset('uploads/'.$appearance->logo)}}"
                                                         alt="logo" width="150">
                                                    <div class="input-group">
                                                ...
                                                <div class="col-md-7">
                                                    <img id="favicon" src="{{asset('uploads/'.$appearance->favicon)}}"
                                                ...
                                                <div class="col-md-7">
                                                    <img id="backend_logo" src="{{asset('uploads/'.$appearance->backend_logo)}}"
