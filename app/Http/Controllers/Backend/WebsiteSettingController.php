...
class WebsiteSettingController extends Controller
{
    ...
    public function appearanceUpdate(Request $request, $id)
    {
        $request->validate([
            ...
            'facebook_link' => ['nullable', 'string', 'max:200'],
            'twitter_link' => ['nullable', 'string', 'max:200'],
            'pinterest_link' => ['nullable', 'string', 'max:200'],
            'instagram_link' => ['nullable', 'string', 'max:200'],
            'linkdin_link' => ['nullable', 'string', 'max:200'],
            'youtube_link' => ['nullable', 'string', 'max:200'],
        ]);
        try {
